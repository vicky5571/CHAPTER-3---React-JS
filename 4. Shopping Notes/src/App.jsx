...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      <GroceryList items={items} onDeleteItem={handleDeteleItem} onToggleItem={handleToggleItem} onClearItems={handleClearItems} />
      <Footer items={items} />
    </div>
  );
}
...
function Footer({ items }) {
  if (!items.length) return <footer className="stats">Daftar belanja kosong!</footer>;
